import { formatGuaLevelLines, KONG_WANG_LABELS, sortYaosDescending, traditionalYaoName, WANG_SHUAI_LABELS, YONG_SHEN_STATUS_LABELS, } from './calculate.js';
import { buildShenSystemMap, mapLiuyaoRelationLabel, normalizeDetailLevel3Way, } from '../../shared/render-utils.js';
...
function buildLiuyaoBoardLines(result, detailLevel) {
...
export function renderLiuyaoJSON(result, options) {
