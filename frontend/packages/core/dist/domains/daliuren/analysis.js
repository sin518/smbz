...
export function buildDaliurenAnalysisBasis(source, timingMethod = 'san-chuan') {
    return {
...
function buildKongWangTiming(source) {
    const grouped = groupTransmissionsByBranch(source);
