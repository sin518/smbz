...
from app.api.routes import admin, ai_analysis, auth, bazi, cron, health, profiles, sync, sync_bazi, sync_divination
...
api_router.include_router(sync_divination.router, tags=["sync"])
